...
-- Thu 01 Jul 2021 10:57:04 AM PDT
...
CREATE TABLE IF NOT EXISTS `ec-schema`.`products` (
  ...
  `product_base_unit_price` DECIMAL(13,2) NOT NULL,
  ...
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` TIMESTAMP NULL,
  `cheapest_price` DECIMAL(13,2) NULL,
  `highest_price` DECIMAL(13,2) NULL,
...
CREATE TABLE IF NOT EXISTS `ec-schema`.`notifications` (
  ...
  `issuer_id` VARCHAR(36) NULL COMMENT 'can be null if guest (e.g., order is placed by a guest)',
...
INSERT INTO `ec-schema`.`user_types` (`user_type_id`, `user_type`, `created_at`, `updated_at`) VALUES (3, 'ANONYMOUS', DEFAULT, NULL);
...
START TRANSACTION;
USE `ec-schema`;
INSERT INTO `ec-schema`.`product_sizes` (`product_size_id`, `product_size_name`, `product_size_description`) VALUES (1, 'XS', 'extra small');
INSERT INTO `ec-schema`.`product_sizes` (`product_size_id`, `product_size_name`, `product_size_description`) VALUES (2, 'S', 'small');
INSERT INTO `ec-schema`.`product_sizes` (`product_size_id`, `product_size_name`, `product_size_description`) VALUES (3, 'M', 'medium');
INSERT INTO `ec-schema`.`product_sizes` (`product_size_id`, `product_size_name`, `product_size_description`) VALUES (4, 'L', 'large');
INSERT INTO `ec-schema`.`product_sizes` (`product_size_id`, `product_size_name`, `product_size_description`) VALUES (5, 'XL', 'extra large');
...
START TRANSACTION;
USE `ec-schema`;
INSERT INTO `ec-schema`.`companies` (`company_id`, `company_name`, `company_description`, `company_email`, `user_id`, `phone_number`, `country_code`, `address_1`, `address_2`, `city`, `province`, `country`, `postal_code`, `facebook_link`, `instagram_link`, `twitter_link`, `youtube_link`) VALUES (1, 'Sample Company Name', 'Sample Company Description', 'sample@company.com', 'e95bf632-1518-4bf2-8ba9-cd8b7587530b', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 'CA', DEFAULT, NULL, NULL, NULL, NULL);
...
START TRANSACTION;
USE `ec-schema`;
INSERT INTO `ec-schema`.`notification_types` (`notification_type_id`, `notification_type`, `notification_title_template`, `issuer_type_id`, `recipient_type_id`) VALUES (1, 'ORDER_WAS_PLACED_BY_MEMBER', 'A New Order Was Placed By Member User.', 2, 1);
...
INSERT INTO `ec-schema`.`notification_types` (`notification_type_id`, `notification_type`, `notification_title_template`, `issuer_type_id`, `recipient_type_id`) VALUES (4, 'ORDER_WAS_PLACED_BY_ANONYMOUS', 'A New Order Was Placed By Guest User.', 3, 1);
INSERT INTO `ec-schema`.`notification_types` (`notification_type_id`, `notification_type`, `notification_title_template`, `issuer_type_id`, `recipient_type_id`) VALUES (5, 'ORDER_STATUS_WAS_UPDATED_BY_MEMBER', 'An Order Status Was Updated By Member User.', 2, 1);
INSERT INTO `ec-schema`.`notification_types` (`notification_type_id`, `notification_type`, `notification_title_template`, `issuer_type_id`, `recipient_type_id`) VALUES (6, 'REVIEW_WAS_UPDATED_BY_MEMBER', 'A Review Was Updated By Member.', 2, 1);
INSERT INTO `ec-schema`.`notification_types` (`notification_type_id`, `notification_type`, `notification_title_template`, `issuer_type_id`, `recipient_type_id`) VALUES (7, 'REVIEW_WAS_VERIFIED_BY_ADMIN', 'Your Review Was Verified.', 1, 2);
