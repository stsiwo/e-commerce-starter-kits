...
-- Mon 10 May 2021 03:16:09 PM PDT
...
START TRANSACTION;
USE `ec-schema`;
INSERT INTO `ec-schema`.`users` (`user_id`, `first_name`, `last_name`, `email`, `password`, `avatar_image_path`, `is_deleted`, `deleted_account_date`, `deleted_account_reason`, `user_type_id`, `created_at`, `updated_at`, `stripe_customer_id`) VALUES ('e95bf632-1518-4bf2-8ba9-cd8b7587530b', 'Admin First Name', 'Admin Last Name', 'test_admin@test.com', '$2a$10$iRnpNpN7XsJq3wjHwRza1eda6CKz.GnMfLAmnozUXepQnm3w7i1yS', NULL, DEFAULT, NULL, NULL, 1, DEFAULT, NULL, NULL);
