...
-- Fri 04 Jun 2021 04:43:00 PM PDT
...
CREATE TABLE IF NOT EXISTS `ec-schema`.`users` (
  ...
  `verification_token` VARCHAR(36) NULL DEFAULT 'default-token',
  `verification_token_expiry_date` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  `forgot_password_token` VARCHAR(36) NULL DEFAULT 'default-token',
