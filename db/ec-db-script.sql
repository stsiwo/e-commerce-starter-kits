...
-- Tue 22 Jun 2021 02:33:58 PM PDT
...
START TRANSACTION;
USE `ec-schema`;
INSERT INTO `ec-schema`.`companies` (`company_id`, `company_name`, `company_description`, `company_email`, `user_id`, `phone_number`, `country_code`, `address_1`, `address_2`, `city`, `province`, `country`, `postal_code`) VALUES (1, 'Sample Company Name', 'Sample Company Description', 'sample@company.com', 'e95bf632-1518-4bf2-8ba9-cd8b7587530b', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 'CA', DEFAULT);
