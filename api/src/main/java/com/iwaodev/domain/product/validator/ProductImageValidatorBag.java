...
@Component
public class ProductImageValidatorBag implements ValidatorBag<ProductImage> {

  @Autowired
  private List<Validator<ProductImage>> validators;

	@Override
	public boolean validateAll(ProductImage domain, String when) throws DomainValidationException {

    boolean result = false;

    for (Validator<ProductImage> validator : this.validators) {
