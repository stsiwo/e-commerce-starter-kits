...
@Component
public class UserAddressValidator implements Validator<Address> {

  private static final Logger logger = LoggerFactory.getLogger(UserAddressValidator.class);
  ...
  @Override
  public boolean validateWhenBoth(Address domain) throws DomainValidationException {

    logger.info("start UserAddressValidator");
    ...
    // isShipping
    if (domain.getIsShippingAddress() == null) {
      throw new DomainValidationException(String.format("is shipping address boolean code can not be null."));
    }

    // isBilling
    if (domain.getIsBillingAddress() == null) {
      throw new DomainValidationException(String.format("is billing address boolean code can not be null."));
    }
  ...
  @Override
  public boolean validateWhenCreate(Address domain) throws DomainValidationException {
    return true;
  }

  @Override
  public boolean validateWhenUpdate(Address domain) throws DomainValidationException {
    return true;
  }
}
