...
@Component
public class UserPhoneValidatorBag implements ValidatorBag<Phone> {

  @Autowired
  private List<Validator<Phone>> validators;

	@Override
	public boolean validateAll(Phone domain, String when) throws DomainValidationException {

    boolean result = false;

    for (Validator<Phone> validator : this.validators) {
