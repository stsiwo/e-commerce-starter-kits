...
INSERT INTO `ec-schema`.`phones` (`phone_id`, `phone_number`, `country_code`, `user_id`) VALUES (100, '1234567890', '+12', '29c845ad-54b1-430a-8a71-5caba98d5978'); -- must match with the user above
