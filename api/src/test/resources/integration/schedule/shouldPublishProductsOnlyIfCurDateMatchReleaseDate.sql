...
-- product (category 1) => this should be true after test
...
-- product (category=1) => this should not be true after test since does not have vany variant.
INSERT INTO `products` (`product_id`, `product_name`, `product_description`, `product_path`, `product_base_unit_price`, `category_id`, `is_public` , `release_date`)
...
-- product (category=1) => this should not be true after test since does not match the date 
INSERT INTO `products` (`product_id`, `product_name`, `product_description`, `product_path`, `product_base_unit_price`, `category_id`, `is_public`, `release_date`)
