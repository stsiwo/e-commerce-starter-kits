...
INSERT INTO `ec-schema`.`cart_items` (`user_id`, `variant_id`, `quantity`) 
VALUES ('c7081519-16e5-4f92-ac50-1834001f12b9', '4', '1'); -- user_id = this test member user's id 

INSERT INTO `ec-schema`.`cart_items` (`user_id`, `variant_id`, `quantity`) 
VALUES ('c7081519-16e5-4f92-ac50-1834001f12b9', '1', '1'); -- user_id = this test member user's id 
