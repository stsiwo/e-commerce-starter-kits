...
VALUES ('9e3e67ca-d058-41f0-aad5-4f09c956a81f', 'test_name_1', 'test_desc_1', 'test-path-1', '12.21', '4.21', '0', '1'); -- make sure product id = 9e3e67ca-d058-41f0-aad5-4f09c956a81f
...
-- product
INSERT INTO `ec-schema`.`products` (`product_id`, `product_name`, `product_description`, `product_path`, `product_base_unit_price`, `average_review_point`, `is_discount`, `category_id`) 
VALUES ('1782be81-2094-4f72-bd02-6bc1129b23e3', 'test_name_2', 'test_desc_2', 'test-path-2', '12.21', '4.21', '0', '1'); -- make sure product id = 1782be81-2094-4f72-bd02-6bc1129b23e3
...
-- product
INSERT INTO `ec-schema`.`products` (`product_id`, `product_name`, `product_description`, `product_path`, `product_base_unit_price`, `average_review_point`, `is_discount`, `category_id`) 
VALUES ('e31414e2-d497-45c2-a114-cd4902d0ab61', 'test_name_2', 'test_desc_2', 'test-path-3', '12.21', '4.21', '0', '1'); -- make sure product id = e31414e2-d497-45c2-a114-cd4902d0ab61
...
-- product - 
INSERT INTO `ec-schema`.`products` (`product_id`, `product_name`, `product_description`, `product_path`, `product_base_unit_price`, `average_review_point`, `is_discount`, `category_id`) 
VALUES ('39dbf162-92c5-4528-bbda-e498ac3aa802', 'test_name_new', 'test_desc_new', 'test-path-4', '12.21', '4.21', '0', '1'); -- make sure product id = 39dbf162-92c5-4528-bbda-e498ac3aa802
...
VALUES ('10', 'c7081519-16e5-4f92-ac50-1834001f12b9', '2', '1'); -- user_id = this test member user's id 

INSERT INTO `ec-schema`.`cart_items` (`cart_item_id`, `user_id`, `variant_id`, `quantity`) 
VALUES ('11', 'c7081519-16e5-4f92-ac50-1834001f12b9', '5', '1'); -- user_id = this test member user's id 

INSERT INTO `ec-schema`.`cart_items` (`cart_item_id`, `user_id`, `variant_id`, `quantity`) -- target cart item
VALUES ('12', 'c7081519-16e5-4f92-ac50-1834001f12b9', '9', '1'); -- user_id = this test member user's id 
