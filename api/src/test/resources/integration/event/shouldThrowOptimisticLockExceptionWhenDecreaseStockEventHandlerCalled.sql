...
VALUES ('1', '1', 'white', '123.00', '1', '9e3e67ca-d058-41f0-aad5-4f09c956a81f', '1.00', '1.00', '1.00', '1.00'); -- make sure stock match with test
...
VALUES ('1', '1', '5.00', 'white', 'XS', 'sample product name 1', 'c8f8591c-bb83-4fd1-a098-3fac8d40e450', '1', '9e3e67ca-d058-41f0-aad5-4f09c956a81f'); -- make sure quantity match with test and exceed stock number
INSERT INTO `order_details` (`order_detail_id`, `product_quantity`, `product_unit_price`, `product_color`, `product_size`, `product_name`, `order_id`, `product_variant_id`, `product_id`)
...
-- order 2
INSERT INTO `orders` (`order_id`, `order_number`, `product_cost`, `tax_cost`, `shipping_cost`, `order_first_name`, `order_last_name`, `order_email`, `order_phone`, `stripe_payment_intent_id`, `is_guest`)
VALUES ('56c2f133-90c7-47cd-81c4-db0478c4ed86', 'order_wylTzSZbxxA', '123.00', '2.00', '10.00', 'first name', 'last name', 'test_order@email.com', '+12342342345', 'sample_stripe_payment_intent_id', '1');

INSERT INTO `order_addresses` (`order_address_id`, `address_1`, `address_2`, `city`, `province`, `country`, `postal_code`, `shipping_order_id`, `billing_order_id`)
VALUES ('3', 'shipping_address_1', 'shipping_address_2', 'shipping_city', 'shipping_province', 'CA', 'V5R 2C1', '56c2f133-90c7-47cd-81c4-db0478c4ed86', NULL);
INSERT INTO `order_addresses` (`order_address_id`, `address_1`, `address_2`, `city`, `province`, `country`, `postal_code`, `shipping_order_id`, `billing_order_id`)
VALUES ('4', 'billing_address_1', 'billing_address_2', 'billing_city', 'billing_province', 'CA', 'V5R 2C1', NULL, '56c2f133-90c7-47cd-81c4-db0478c4ed86');


-- order detail
INSERT INTO `order_details` (`order_detail_id`, `product_quantity`, `product_unit_price`, `product_color`, `product_size`, `product_name`, `order_id`, `product_variant_id`, `product_id`)
VALUES ('4', '1', '5.00', 'white', 'XS', 'sample product name 1', '56c2f133-90c7-47cd-81c4-db0478c4ed86', '1', '9e3e67ca-d058-41f0-aad5-4f09c956a81f'); -- make sure quantity match with test and exceed stock number
INSERT INTO `order_details` (`order_detail_id`, `product_quantity`, `product_unit_price`, `product_color`, `product_size`, `product_name`, `order_id`, `product_variant_id`, `product_id`)
VALUES ('5', '1', '10.00', 'purple', 'M', 'sample product name 2', '56c2f133-90c7-47cd-81c4-db0478c4ed86', '9', '773f1fc7-c037-447a-a5b2-f790ea2302e5');-- make sure quantity match with test
INSERT INTO `order_details` (`order_detail_id`, `product_quantity`, `product_unit_price`, `product_color`, `product_size`, `product_name`, `order_id`, `product_variant_id`, `product_id`)
VALUES ('6', '1', '3.00', 'white', 'XS', 'sample product name 3', '56c2f133-90c7-47cd-81c4-db0478c4ed86', '13', 'a362bbc3-5c70-4e82-96d3-5fa1e3103332');-- make sure quantity match with test

-- order event

INSERT INTO `order_events` (`order_event_id`, `order_id`, `order_status`, `undoable`, `user_id`, `is_guest`)
VALUES ('4', '56c2f133-90c7-47cd-81c4-db0478c4ed86', 'DRAFT', '0', 'c7081519-16e5-4f92-ac50-1834001f12b9', '0');
INSERT INTO `order_events` (`order_event_id`, `order_id`, `order_status`, `undoable`, `user_id`, `is_guest`)
VALUES ('5', '56c2f133-90c7-47cd-81c4-db0478c4ed86', 'ORDERED', '0', 'c7081519-16e5-4f92-ac50-1834001f12b9', '0');
INSERT INTO `order_events` (`order_event_id`, `order_id`, `order_status`, `undoable`, `user_id`, `is_guest`)
VALUES ('6', '56c2f133-90c7-47cd-81c4-db0478c4ed86', 'PAID', '0', 'c7081519-16e5-4f92-ac50-1834001f12b9', '0');
