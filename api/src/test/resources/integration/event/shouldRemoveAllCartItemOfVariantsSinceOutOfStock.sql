...
INSERT INTO `product_variants` (`variant_id`, `product_size_id`, `variant_color`, `variant_stock`, `product_id`, `variant_weight`, `variant_width`, `variant_height`, `variant_length`)
VALUES ('9', '4', 'aqua', '5', '773f1fc7-c037-447a-a5b2-f790ea2302e5', '1.00', '1.00', '1.00', '1.00');
...
INSERT INTO `product_variants` (`variant_id`, `product_size_id`, `variant_color`, `variant_unit_price`, `variant_stock`, `product_id`, `variant_weight`, `variant_width`, `variant_height`, `variant_length`)
VALUES ('14', '1', 'white', '123.00', '3', 'de7e767d-cd0c-4705-b633-353b2340715b', '1.00', '1.00', '1.00', '1.00');
...
VALUES ('c8f8591c-bb83-4fd1-a098-3fac8d40e450', 'order_w0vDYZvqy_Y', '123.00', '2.00', '10.00', 'c7081519-16e5-4f92-ac50-1834001f12b9', 'first name', 'last name', 'test_order@email.com', '+12342342345', 'dummy_stripe_payment_intent_1', '1');
...
INSERT INTO `order_details` (`order_detail_id`, `product_quantity`, `product_unit_price`, `product_color`, `product_size`, `product_name`, `order_id`, `product_variant_id`, `product_id`)
VALUES ('2', '5', '10.00', 'purple', 'M', 'sample product name 2', 'c8f8591c-bb83-4fd1-a098-3fac8d40e450', '9', '773f1fc7-c037-447a-a5b2-f790ea2302e5');
INSERT INTO `order_details` (`order_detail_id`, `product_quantity`, `product_unit_price`, `product_color`, `product_size`, `product_name`, `order_id`, `product_variant_id`, `product_id`)
VALUES ('3', '3', '3.00', 'white', 'XS', 'sample product name 3', 'c8f8591c-bb83-4fd1-a098-3fac8d40e450', '14', 'de7e767d-cd0c-4705-b633-353b2340715b');
...
INSERT INTO `ec-schema`.`cart_items` (`user_id`, `variant_id`, `quantity`)
VALUES ('a2901f19-715a-44fe-9701-fae6713fd764', '3', '1');

INSERT INTO `ec-schema`.`cart_items` (`user_id`, `variant_id`, `quantity`)
VALUES ('a2901f19-715a-44fe-9701-fae6713fd764', '9', '1');

INSERT INTO `ec-schema`.`cart_items` (`user_id`, `variant_id`, `quantity`)
VALUES ('a2901f19-715a-44fe-9701-fae6713fd764', '14', '1');


INSERT INTO `ec-schema`.`cart_items` (`user_id`, `variant_id`, `quantity`)
VALUES ('d2474e1c-4c69-467b-8a7f-11d3ffe8d6d3', '7', '1');

INSERT INTO `ec-schema`.`cart_items` (`user_id`, `variant_id`, `quantity`)
VALUES ('d2474e1c-4c69-467b-8a7f-11d3ffe8d6d3', '9', '1');

INSERT INTO `ec-schema`.`cart_items` (`user_id`, `variant_id`, `quantity`)
VALUES ('d2474e1c-4c69-467b-8a7f-11d3ffe8d6d3', '14', '1');
