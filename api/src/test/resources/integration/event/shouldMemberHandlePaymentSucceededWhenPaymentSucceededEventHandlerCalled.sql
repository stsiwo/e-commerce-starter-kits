-- update test main member to add stripe customer id for this test
UPDATE users SET `stripe_customer_id` = 'sample_stripe_customer_id' WHERE `user_id` = 'c7081519-16e5-4f92-ac50-1834001f12b9'; -- test main member.
...
VALUES ('1', '1', 'white', '123.00', '12', '9e3e67ca-d058-41f0-aad5-4f09c956a81f', '1.00', '1.00', '1.00', '1.00'); -- target product variant & make sure stock. 
...
INSERT INTO `product_variants` (`variant_id`, `product_size_id`, `variant_color`, `variant_stock`, `product_id`, `variant_weight`, `variant_width`, `variant_height`, `variant_length`)
VALUES ('9', '4', 'aqua', '6', '773f1fc7-c037-447a-a5b2-f790ea2302e5', '1.00', '1.00', '1.00', '1.00'); -- target product variant & make sure stock.
...
INSERT INTO `product_variants` (`variant_id`, `product_size_id`, `variant_color`, `variant_stock`, `product_id`, `variant_weight`, `variant_width`, `variant_height`, `variant_length`)
VALUES ('13', '4', 'aqua', '6', 'a362bbc3-5c70-4e82-96d3-5fa1e3103332', '1.00', '1.00', '1.00', '1.00'); -- target product variant & make sure stock.

-- cart items for this user
INSERT INTO `ec-schema`.`cart_items` (`user_id`, `variant_id`, `quantity`, `is_selected`)
VALUES ('c7081519-16e5-4f92-ac50-1834001f12b9', '1', '3', '1'); -- must match with order_details below.

INSERT INTO `ec-schema`.`cart_items` (`user_id`, `variant_id`, `quantity`, `is_selected`)
VALUES ('c7081519-16e5-4f92-ac50-1834001f12b9', '9', '1', '1'); -- must match with order_details below.

INSERT INTO `ec-schema`.`cart_items` (`user_id`, `variant_id`, `quantity`, `is_selected`)
VALUES ('c7081519-16e5-4f92-ac50-1834001f12b9', '13', '1', '1'); -- must match with order_details below.

INSERT INTO `ec-schema`.`cart_items` (`user_id`, `variant_id`, `quantity`, `is_selected`)
VALUES ('c7081519-16e5-4f92-ac50-1834001f12b9', '12', '1', '0'); -- non selected 

INSERT INTO `ec-schema`.`cart_items` (`user_id`, `variant_id`, `quantity`, `is_selected`)
VALUES ('c7081519-16e5-4f92-ac50-1834001f12b9', '7', '1', '0'); -- non selected 


-- target order
INSERT INTO `orders` (`order_id`, `order_number`, `product_cost`, `tax_cost`, `shipping_cost`, `order_first_name`, `order_last_name`, `order_email`, `order_phone`, `stripe_payment_intent_id`, `user_id`)
VALUES ('c8f8591c-bb83-4fd1-a098-3fac8d40e450', 'order_w0vDYZvqy_Y', '123.00', '2.00', '10.00', 'first name', 'last name', 'test_order@email.com', '+12342342345', 'sample_stripe_payment_intent_id', 'c7081519-16e5-4f92-ac50-1834001f12b9'); -- target order & don't forget assign user_id: test main member
...
VALUES ('1', '3', '5.00', 'white', 'XS', 'sample product name 1', 'c8f8591c-bb83-4fd1-a098-3fac8d40e450', '1', '9e3e67ca-d058-41f0-aad5-4f09c956a81f'); -- make sure quantity match with test and exceed stock number
INSERT INTO `order_details` (`order_detail_id`, `product_quantity`, `product_unit_price`, `product_color`, `product_size`, `product_name`, `order_id`, `product_variant_id`, `product_id`)
...
VALUES ('56', 'c8f8591c-bb83-4fd1-a098-3fac8d40e450', 'DRAFT', '0', NULL);

INSERT INTO `order_events` (`order_event_id`, `order_id`, `order_status`, `undoable`, `user_id`)
VALUES ('57', 'c8f8591c-bb83-4fd1-a098-3fac8d40e450', 'ORDERED', '0', NULL);
