...
VALUES ('c8f8591c-bb83-4fd1-a098-3fac8d40e450', 'order_w0vDYZvqy_Y', '123.00', '2.00', '10.00', NULL, 'first name', 'last name', 'test_order@email.com', '+12342342345', 'sample_stripe_payment_intent_id_1', '1');
...
INSERT INTO `order_events` (`order_event_id`, `order_id`, `order_status`, `undoable`, `user_id`, `is_guest`)
VALUES ('100', 'c8f8591c-bb83-4fd1-a098-3fac8d40e450', 'RECEIVED_CANCEL_REQUEST', '0', 'c7081519-16e5-4f92-ac50-1834001f12b9', '1');
