...
INSERT INTO `ec-schema`.`users` (`user_id`, `first_name`, `last_name`, `email`, `password`, `user_type_id`, `created_at`, `updated_at`, `active`) 
VALUES ('69be6667-bd32-4287-ba8b-3b4230ea6b44', 'first_name_2', 'last_name_2', 'test_2@test.com', '$2a$10$iRnpNpN7XsJq3wjHwRza1eda6CKz.GnMfLAmnozUXepQnm3w7i1yS', '2', '2020-01-01 16:27:55', '2020-01-01 16:27:55', 'ACTIVE');
