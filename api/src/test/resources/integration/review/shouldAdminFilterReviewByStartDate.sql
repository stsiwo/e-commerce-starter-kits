...
-- reviews
INSERT INTO `reviews` (`user_id`, `product_id`, `review_point`, `review_title`, `review_description`, `is_verified`, `created_at`)
VALUES ('c7081519-16e5-4f92-ac50-1834001f12b9', '9e3e67ca-d058-41f0-aad5-4f09c956a81f', '3.9', 'sample title 1', 'sample description', 0, '2020-01-07 00:00:00');

INSERT INTO `reviews` (`user_id`, `product_id`, `review_point`, `review_title`, `review_description`, `is_verified`, `created_at`)
VALUES ('c7081519-16e5-4f92-ac50-1834001f12b9', '773f1fc7-c037-447a-a5b2-f790ea2302e5', '4.9', 'sample title 2', 'sample description', 1, '2019-01-07 00:00:00');

INSERT INTO `reviews` (`user_id`, `product_id`, `review_point`, `review_title`, `review_description`, `is_verified`, `created_at`)
VALUES ('c7081519-16e5-4f92-ac50-1834001f12b9', 'a362bbc3-5c70-4e82-96d3-5fa1e3103332', '2.0', 'sample title 3', 'sample description', 0, '2018-01-07 00:00:00');

INSERT INTO `reviews` (`user_id`, `product_id`, `review_point`, `review_title`, `review_description`, `is_verified`, `created_at`)
VALUES ('a2901f19-715a-44fe-9701-fae6713fd764', '9e3e67ca-d058-41f0-aad5-4f09c956a81f', '3.0', 'sample title 4', 'sample description', 1, '2021-01-07 00:00:00');

INSERT INTO `reviews` (`user_id`, `product_id`, `review_point`, `review_title`, `review_description`, `is_verified`, `created_at`)
VALUES ('a2901f19-715a-44fe-9701-fae6713fd764', '773f1fc7-c037-447a-a5b2-f790ea2302e5', '1.0', 'sample title 5', 'sample description', 0, '2022-01-07 00:00:00');

INSERT INTO `reviews` (`user_id`, `product_id`, `review_point`, `review_title`, `review_description`, `is_verified`, `created_at`)
VALUES ('a2901f19-715a-44fe-9701-fae6713fd764', 'a362bbc3-5c70-4e82-96d3-5fa1e3103332', '0.5', 'sample title 6', 'sample description', 1, '2023-01-07 00:00:00');

INSERT INTO `reviews` (`user_id`, `product_id`, `review_point`, `review_title`, `review_description`, `is_verified`, `created_at`)
VALUES ('d2474e1c-4c69-467b-8a7f-11d3ffe8d6d3', '9e3e67ca-d058-41f0-aad5-4f09c956a81f', '4.0', 'sample title 7', 'sample description', 0, '2024-01-07 00:00:00');

INSERT INTO `reviews` (`user_id`, `product_id`, `review_point`, `review_title`, `review_description`, `is_verified`, `created_at`)
VALUES ('d2474e1c-4c69-467b-8a7f-11d3ffe8d6d3', '773f1fc7-c037-447a-a5b2-f790ea2302e5', '5.0', 'sample title 8', 'sample description', 1, '2025-01-07 00:00:00');

INSERT INTO `reviews` (`user_id`, `product_id`, `review_point`, `review_title`, `review_description`, `is_verified`, `created_at`)
VALUES ('d2474e1c-4c69-467b-8a7f-11d3ffe8d6d3', 'a362bbc3-5c70-4e82-96d3-5fa1e3103332', '2.0', 'sample title 9', 'sample description', 0, '2026-01-07 00:00:00');
