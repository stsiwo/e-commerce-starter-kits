...
-- product
INSERT INTO `ec-schema`.`products` (`product_id`, `product_name`, `product_description`, `product_path`, `product_base_unit_price`, `average_review_point`, `category_id`, `cheapest_price`, `highest_price`) 
VALUES ('9e3e67ca-d058-41f0-aad5-4f09c956a81f', 'test_name_1', 'test_desc_1', 'test-path-1', '12.21', '4.21', '1', 11.00, 20.00); -- make sure product id = 9e3e67ca-d058-41f0-aad5-4f09c956a81f

-- product variants
INSERT INTO `ec-schema`.`product_variants` (`variant_id`, `product_size_id`, `variant_color`, `variant_unit_price`, `variant_stock`, `product_id`, `variant_weight`, `variant_width`, `variant_height`, `variant_length`, `is_discount`, `variant_discount_price`, `variant_discount_start_date`, `variant_discount_end_date`) 
VALUES ('1', '1', 'white', '12.00', '12', '9e3e67ca-d058-41f0-aad5-4f09c956a81f', '1.00', '1.00', '1.00', '1.00', '1', 11.50 , '2021-01-07 00:00:00', '2022-01-07 00:00:00'); -- make sure variant id = 1
...
-- product
INSERT INTO `ec-schema`.`products` (`product_id`, `product_name`, `product_description`, `product_path`, `product_base_unit_price`, `average_review_point`, `category_id`, `cheapest_price`, `highest_price`) 
VALUES ('1782be81-2094-4f72-bd02-6bc1129b23e3', 'test_name_2', 'test_desc_2', 'test-path-2', '60.21', '2.21', '1', 40.00, 60.21); -- make sure product id = 1782be81-2094-4f72-bd02-6bc1129b23e3
...
INSERT INTO `ec-schema`.`product_variants` (`variant_id`, `product_size_id`, `variant_color`, `variant_unit_price`, `variant_stock`, `product_id`, `variant_weight`, `variant_width`, `variant_height`, `variant_length`, `is_discount`, `variant_discount_price`, `variant_discount_start_date`, `variant_discount_end_date`) 
VALUES ('5', '1', 'white', '50.00', '12', '1782be81-2094-4f72-bd02-6bc1129b23e3', '1.00', '1.00', '1.00', '1.00', '1', 45.00, '2021-01-07 00:00:00', '2022-01-07 00:00:00'); -- make sure variant id = 5
...
-- product
INSERT INTO `ec-schema`.`products` (`product_id`, `product_name`, `product_description`, `product_path`, `product_base_unit_price`, `average_review_point`, `category_id`, `cheapest_price`, `highest_price`) 
VALUES ('e31414e2-d497-45c2-a114-cd4902d0ab61', 'test_name_2', 'test_desc_2', 'test-path-3', '100.21', '1.21', '1', 100.21, 140.00); -- make sure product id = e31414e2-d497-45c2-a114-cd4902d0ab61
