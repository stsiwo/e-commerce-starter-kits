...
VALUES ('9e3e67ca-d058-41f0-aad5-4f09c956a81f', 'test_Z', 'test_desc_1', 'test-path-1', '12.21', '4.21', '1', 11.00, 20.00, '2021-01-07 00:00:00'); -- make sure product id = 9e3e67ca-d058-41f0-aad5-4f09c956a81f
...
-- product
INSERT INTO `ec-schema`.`products` (`product_id`, `product_name`, `product_description`, `product_path`, `product_base_unit_price`, `average_review_point`, `category_id`, `cheapest_price`, `highest_price`, `release_date`) 
VALUES ('1782be81-2094-4f72-bd02-6bc1129b23e3', 'test_D', 'test_desc_2', 'test-path-2', '60.21', '2.21', '1', 40.00, 60.21, '2019-01-07 00:00:00'); -- make sure product id = 1782be81-2094-4f72-bd02-6bc1129b23e3
...
-- product
INSERT INTO `ec-schema`.`products` (`product_id`, `product_name`, `product_description`, `product_path`, `product_base_unit_price`, `average_review_point`, `category_id`, `cheapest_price`, `highest_price`, `release_date`) 
VALUES ('e31414e2-d497-45c2-a114-cd4902d0ab61', 'test_A', 'test_desc_2', 'test-path-3', '100.21', '1.21', '1', 100.21, 140.00, '2020-01-07 00:00:00'); -- make sure product id = e31414e2-d497-45c2-a114-cd4902d0ab61
...
INSERT INTO `ec-schema`.`wishlist_items` (`user_id`, `variant_id`, `created_at`)
VALUES ('c7081519-16e5-4f92-ac50-1834001f12b9', '1', '2021-01-07 00:00:00'); -- user_id = this test member user's id

INSERT INTO `ec-schema`.`wishlist_items` (`user_id`, `variant_id`, `created_at`)
VALUES ('c7081519-16e5-4f92-ac50-1834001f12b9', '9', '2021-05-07 00:00:00'); -- user_id = this test member user's id

INSERT INTO `ec-schema`.`wishlist_items` (`user_id`, `variant_id`, `created_at`)
VALUES ('c7081519-16e5-4f92-ac50-1834001f12b9', '2', '2021-03-07 00:00:00'); -- user_id = this test member user's id

INSERT INTO `ec-schema`.`wishlist_items` (`user_id`, `variant_id`, `created_at`)
VALUES ('c7081519-16e5-4f92-ac50-1834001f12b9', '5', '2021-09-07 00:00:00'); -- user_id = this test member user's id
