...
INSERT INTO `ec-schema`.`wishlist_items` (`user_id`, `variant_id`, `created_at`)
VALUES ('c7081519-16e5-4f92-ac50-1834001f12b9', '2', '2021-05-07 00:00:00'); -- user_id = this test member user's id

INSERT INTO `ec-schema`.`wishlist_items` (`user_id`, `variant_id`, `created_at`)
VALUES ('c7081519-16e5-4f92-ac50-1834001f12b9', '5', '2021-03-07 00:00:00'); -- user_id = this test member user's id

INSERT INTO `ec-schema`.`wishlist_items` (`user_id`, `variant_id`, `created_at`)
VALUES ('c7081519-16e5-4f92-ac50-1834001f12b9', '9', '2021-09-07 00:00:00'); -- user_id = this test member user's id
