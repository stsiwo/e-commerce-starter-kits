...
VALUES ('9e3e67ca-d058-41f0-aad5-4f09c956a81f', 'Game_name_1', 'test_desc_1', 'test-path-1', '12.21', '4.21', '1', 11.00, 20.00); -- make sure product id = 9e3e67ca-d058-41f0-aad5-4f09c956a81f
...
-- product
INSERT INTO `ec-schema`.`products` (`product_id`, `product_name`, `product_description`, `product_path`, `product_base_unit_price`, `average_review_point`, `category_id`, `cheapest_price`, `highest_price`) 
VALUES ('e31414e2-d497-45c2-a114-cd4902d0ab61', 'test_name_2', 'test_desc_2_Game', 'test-path-3', '100.21', '1.21', '1', 100.21, 140.00); -- make sure product id = e31414e2-d497-45c2-a114-cd4902d0ab61
