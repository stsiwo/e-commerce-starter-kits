...
VALUES ('10', 'c7081519-16e5-4f92-ac50-1834001f12b9', '2'); -- user_id = this test member user's id 

INSERT INTO `ec-schema`.`wishlist_items` (`wishlist_item_id`, `user_id`, `variant_id`) 
VALUES ('11', 'c7081519-16e5-4f92-ac50-1834001f12b9', '5'); -- user_id = this test member user's id 

INSERT INTO `ec-schema`.`wishlist_items` (`wishlist_item_id`, `user_id`, `variant_id`) -- target cart item
VALUES ('12', 'c7081519-16e5-4f92-ac50-1834001f12b9', '9'); -- user_id = this test member user's id 
