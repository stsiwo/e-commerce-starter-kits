...
-- product images
INSERT INTO `ec-schema`.`product_images` (`product_image_id`, `product_image_path`, `product_image_name`, `product_id`, `is_change`) VALUES ('10', '/images/product-image-0.png', 'product-image-0', '9e3e67ca-d058-41f0-aad5-4f09c956a81f', 0); -- make sure product_image_id match with input json script
INSERT INTO `ec-schema`.`product_images` (`product_image_id`, `product_image_path`, `product_image_name`, `product_id`, `is_change`) VALUES ('11', '/images/product-image-1.png', 'product-image-1', '9e3e67ca-d058-41f0-aad5-4f09c956a81f', 0);-- make sure product_image_id match with input json script
...
INSERT INTO `ec-schema`.`product_images` (`product_image_id`, `product_image_path`, `product_image_name`, `product_id`, `is_change`) VALUES ('13', '/images/product-image-3.png', 'product-image-3', '9e3e67ca-d058-41f0-aad5-4f09c956a81f', 0);-- make sure product_image_id match with input json script
