package com.iwaodev.unit.domain.event.wishlistItem;
...
public class MovedWishlistItemToCartItemEventTest {

  private static final Logger logger = LoggerFactory.getLogger(MovedWishlistItemToCartItemEventTest.class);
  ...
  public void shouldAllEventHandlersCalled() throws Exception {
    ...
    registeredEventHandlers.add(CreateCartItemEventHandler.class);


    Set<Class<? extends EventHandler>> result = this.testUtil.getAllEventHandlerOfEvent(MovedWishlistItemToCartItemEvent.class);
