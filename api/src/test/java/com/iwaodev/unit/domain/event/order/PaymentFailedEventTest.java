...
public class PaymentFailedEventTest {

  private static final Logger logger = LoggerFactory.getLogger(PaymentFailedEventTest.class);
  ...
  public void shouldAllEventHandlersCalled() throws Exception {
    ...
    registeredEventHandlers.add(PaymentFailedEventHandler.class);

    Set<Class<? extends EventHandler>> result = this.testUtil.getAllEventHandlerOfEvent(PaymentFailedEvent.class);
