...
public class NewReviewWasSubmittedEventTest {

  private static final Logger logger = LoggerFactory.getLogger(NewReviewWasSubmittedEventTest.class);
  ...
  public void shouldAllEventHandlersCalled() throws Exception {
    ...
    registeredEventHandlers.add(CreateReviewNotificationForAdminEventHandler.class);


    Set<Class<? extends EventHandler>> result = this.testUtil.getAllEventHandlerOfEvent(NewReviewWasSubmittedEvent.class);
