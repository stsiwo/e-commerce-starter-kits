...
public class OrderFinalConfirmedEventTest {

  private static final Logger logger = LoggerFactory.getLogger(OrderFinalConfirmedEventTest.class);
  ...
  public void shouldAllEventHandlersCalled() throws Exception {
    ...
    registeredEventHandlers.add(DecreaseProductStockEventHandler.class);
    registeredEventHandlers.add(AssignStripeCustomerIdEventHandler.class);

    Set<Class<? extends EventHandler>> result = this.testUtil.getAllEventHandlerOfEvent(OrderFinalConfirmedEvent.class);
