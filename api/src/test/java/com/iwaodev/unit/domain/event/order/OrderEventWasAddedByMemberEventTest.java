...
public class OrderEventWasAddedByMemberEventTest {

  private static final Logger logger = LoggerFactory.getLogger(OrderEventWasAddedByMemberEventTest.class);
  ...
  public void shouldAllEventHandlersCalled() throws Exception {
    ...
    registeredEventHandlers.add(CreateOrderEventNotificationForMemberEventHandler.class);
    registeredEventHandlers.add(SendCancelRequestSubmittedEmailEventHandler.class);
    registeredEventHandlers.add(SendReturnRequestSubmittedEmailEventHandler.class);

    Set<Class<? extends EventHandler>> result = this.testUtil.getAllEventHandlerOfEvent(OrderEventWasAddedByMemberEvent.class);
