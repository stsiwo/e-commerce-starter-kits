package com.iwaodev.unit.domain.event.user;
...
public class GeneratedForgotPasswordTokenEventTest {

  private static final Logger logger = LoggerFactory.getLogger(GeneratedForgotPasswordTokenEventTest.class);
  ...
  public void shouldAllEventHandlersCalled() throws Exception {
    ...
    registeredEventHandlers.add(SendForgotPasswordEmailEventHandler.class);


    Set<Class<? extends EventHandler>> result = this.testUtil.getAllEventHandlerOfEvent(GeneratedForgotPasswordTokenEvent.class);
