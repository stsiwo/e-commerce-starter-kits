...
public class ReviewWasVerifiedByAdminEventTest {

  private static final Logger logger = LoggerFactory.getLogger(ReviewWasVerifiedByAdminEventTest.class);
  ...
  public void shouldAllEventHandlersCalled() throws Exception {
    ...
    registeredEventHandlers.add(CreateReviewVerifiedNotificationForMemberEventHandler.class);


    Set<Class<? extends EventHandler>> result = this.testUtil.getAllEventHandlerOfEvent(ReviewWasVerifiedByAdminEvent.class);
