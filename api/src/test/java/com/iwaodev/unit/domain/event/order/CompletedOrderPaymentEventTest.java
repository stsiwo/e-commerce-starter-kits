...
public class CompletedOrderPaymentEventTest {

  private static final Logger logger = LoggerFactory.getLogger(CompletedOrderPaymentEventTest.class);
  ...
  public void shouldAllEventHandlersCalled() throws Exception {
    ...
    registeredEventHandlers.add(AddSoldCountEventHandler.class);

    Set<Class<? extends EventHandler>> result = this.testUtil.getAllEventHandlerOfEvent(CompletedOrderPaymentEvent.class);
