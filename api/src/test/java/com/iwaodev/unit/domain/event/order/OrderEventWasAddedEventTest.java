...
public class OrderEventWasAddedEventTest {

  private static final Logger logger = LoggerFactory.getLogger(OrderEventWasAddedEventTest.class);
  ...
  public void shouldAllEventHandlersCalled() throws Exception {
    ...
    registeredEventHandlers.add(RefundPaymentEventHandler.class);
    registeredEventHandlers.add(SendOrderWasShippedEmailEventHandler.class);
    registeredEventHandlers.add(SendPleaseReviewEmailEventHandler.class);
    registeredEventHandlers.add(CreateOrderEventNotificationEventHandler.class);
    registeredEventHandlers.add(SendCancelRequestWasConfirmedEmailEventHandler.class);
