...
public class GeneratedVerificationTokenEventTest {

  private static final Logger logger = LoggerFactory.getLogger(GeneratedVerificationTokenEventTest.class);
  ...
  public void shouldAllEventHandlersCalled() throws Exception {
    ...
    registeredEventHandlers.add(SendVerificationEmailEventHandler.class);


    Set<Class<? extends EventHandler>> result = this.testUtil.getAllEventHandlerOfEvent(GeneratedVerificationTokenEvent.class);
