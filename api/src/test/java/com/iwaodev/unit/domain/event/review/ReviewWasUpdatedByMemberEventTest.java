package com.iwaodev.unit.domain.event.review;
...
public class ReviewWasUpdatedByMemberEventTest {

  private static final Logger logger = LoggerFactory.getLogger(ReviewWasUpdatedByMemberEventTest.class);
  ...
  public void shouldAllEventHandlersCalled() throws Exception {
    ...
    registeredEventHandlers.add(SendReviewWasUpdatedEmailEventHandler.class);


    Set<Class<? extends EventHandler>> result = this.testUtil.getAllEventHandlerOfEvent(ReviewWasUpdatedByMemberEvent.class);
