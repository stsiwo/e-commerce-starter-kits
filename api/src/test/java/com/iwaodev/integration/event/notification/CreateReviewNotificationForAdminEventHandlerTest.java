...
import com.iwaodev.application.event.notification.CreateReviewNotificationForAdminEventHandler;
...
public class CreateReviewNotificationForAdminEventHandlerTest {
    ...
    @Autowired
    private CreateReviewNotificationForAdminEventHandler handler;
    ...
    @Test
    @Sql(scripts = { "classpath:/integration/event/shouldCreateReviewUpdatedNotificationByMember.sql" })
    public void shouldCreateReviewUpdatedNotificationByMember() throws Exception {
        ...
        // act & assert
        this.handler.handleEvent(new NewReviewWasSubmittedEvent(this, dummyReview));
        ...
        NotificationType notificationTypeEntity = Optional.ofNullable(notificationTypeList.get(NotificationTypeEnum.REVIEW_WAS_UPDATED_BY_MEMBER))
        ...
        assertThat(notification.getNotificationTitle()).isEqualTo(notificationTypeEntity.getNotificationTitleTemplate());
        assertThat(notification.getIssuer().getUserId()).isEqualTo(dummyReview.getUser().getUserId());
        assertThat(notification.getRecipient().getUserId()).isEqualTo(admin.getUserId());
        assertThat(notification.getLink()).isEqualTo(String.format("/admin/reviews?reviewId=%s", dummyReview.getReviewId()));
    }
