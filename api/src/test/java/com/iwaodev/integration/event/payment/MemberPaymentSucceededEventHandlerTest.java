...
public class MemberPaymentSucceededEventHandlerTest {

  private static final Logger logger = LoggerFactory.getLogger(MemberPaymentSucceededEventHandlerTest.class);
  ...
  @Test
  @Sql(scripts = { "classpath:/integration/event/shouldMemberHandlePaymentSucceededWhenPaymentSucceededEventHandlerCalled.sql" })
  public void shouldMemberHandlePaymentSucceededWhenPaymentSucceededEventHandlerCalled(/**@Value("classpath:/integration/event/shouldAddSoldCountSuccessfullyWhenAddSoldCountEventHandlerCalled.json") Resource dummyFormJsonFile**/) throws Exception {
    ...
    assertThat(2).isEqualTo(dummyUser.getCartItems().size());
