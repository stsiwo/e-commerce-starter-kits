...
public class SendForgotPasswordEmailEventHandlerTest {

  private static final Logger logger = LoggerFactory.getLogger(SendForgotPasswordEmailEventHandlerTest.class);
  ...
  @Autowired
  private SendForgotPasswordEmailEventHandler handler;
  ...
  @Test
  //@Sql(scripts = { "classpath:/integration/event/shouldSendForgotPasswordEmailSuccessfullyWhenSendForgotPasswordventHandlerCalled.sql" })
  public void shouldSendForgotPasswordEmailSuccessfullyWhenSendForgotPasswordventHandlerCalled() throws Exception {
