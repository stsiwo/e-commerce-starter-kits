...
public class SendOrderWasShippedEmailEventHandlerTest {

  private static final Logger logger = LoggerFactory.getLogger(SendOrderWasShippedEmailEventHandlerTest.class);
  ...
  @Autowired
  private SendOrderWasShippedEmailEventHandler handler;
  ...
  @Test
  @Sql(scripts = { "classpath:/integration/event/shouldNotSendOrderWasShippedEmailIfOrderStatusIsNotShipped.sql" })
  public void shouldNotSendOrderWasShippedEmailIfOrderStatusIsNotShipped() throws Exception {
  ...
  @Test
  @Sql(scripts = { "classpath:/integration/event/shouldSendOrderWasShippedEmail.sql" })
  public void shouldSendOrderWasShippedEmail() throws Exception {
    ...
    // assert
    Mockito.verify(this.emailService, Mockito.times(1)).send(Mockito.eq(dummyOrder.getOrderEmail()), Mockito.anyString(), Mockito.eq(String.format("Your Order Has Been Shipped (Order #: %s)", dummyOrder.getOrderNumber())), Mockito.anyString());
  }
}
