...
public class SendCancelRequestSubmittedEmailEventHandlerTest {

  private static final Logger logger = LoggerFactory.getLogger(SendCancelRequestSubmittedEmailEventHandlerTest.class);
  ...
  @Autowired
  private SendCancelRequestSubmittedEmailEventHandler handler;
  ...
  @Test
  @Sql(scripts = { "classpath:/integration/event/shouldNotSendCancelRequestEmailIfOrderStatusIsNotCancelRequest.sql" })
  public void shouldNotSendCancelRequestEmailIfOrderStatusIsNotCancelRequest() throws Exception {
  ...
  @Test
  @Sql(scripts = { "classpath:/integration/event/shouldSendCancelRequestEmail.sql" })
  public void shouldSendCancelRequestEmail() throws Exception {
