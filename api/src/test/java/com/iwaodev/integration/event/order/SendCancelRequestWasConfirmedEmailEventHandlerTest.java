...
public class SendCancelRequestWasConfirmedEmailEventHandlerTest {

  private static final Logger logger = LoggerFactory.getLogger(SendCancelRequestWasConfirmedEmailEventHandlerTest.class);
  ...
  @Autowired
  private SendCancelRequestWasConfirmedEmailEventHandler handler;
  ...
  @Test
  @Sql(scripts = { "classpath:/integration/event/shouldNotSendCancelRequestWasConfirmedEmailIfOrderStatusIsNotCancelRequestConfirmed.sql" })
  public void shouldNotSendCancelRequestWasConfirmedEmailIfOrderStatusIsNotCancelRequestConfirmed() throws Exception {
  ...
  @Test
  @Sql(scripts = { "classpath:/integration/event/shouldSendCancelRequestWasConfirmedEmail.sql" })
  public void shouldSendCancelRequestWasConfirmedEmail() throws Exception {
    ...
    // assert
    Mockito.verify(this.emailService, Mockito.times(1)).send(Mockito.eq(dummyOrder.getOrderEmail()), Mockito.anyString(), Mockito.eq("Your Cancel Request Was Confirmed (Order #" + dummyOrder.getOrderNumber()), Mockito.anyString());
  }
}
