...
import com.iwaodev.application.event.order.SendNewOrderWasPlacedEmailEventHandler;
...
public class SendNewOrderWasPlacedEmailEventHandlerTest {

  private static final Logger logger = LoggerFactory.getLogger(SendNewOrderWasPlacedEmailEventHandlerTest.class);
  ...
  @Autowired
  private SendNewOrderWasPlacedEmailEventHandler handler;
  ...
  @Test
  @Sql(scripts = { "classpath:/integration/event/shouldSendNewOrderWasPlacedEmail.sql" })
  public void shouldSendNewOrderWasPlacedEmail() throws Exception {
