...
public class SendPleaseReviewEmailEventHandlerTest {

  private static final Logger logger = LoggerFactory.getLogger(SendPleaseReviewEmailEventHandlerTest.class);
  ...
  @Autowired
  private SendPleaseReviewEmailEventHandler handler;
  ...
  @Test
  @Sql(scripts = { "classpath:/integration/event/shouldNotSendPleaseReviewEmailIfCustomerIsGuest.sql" })
  public void shouldNotSendPleaseReviewEmailIfCustomerIsGuest() throws Exception {
  ...
  @Test
  @Sql(scripts = { "classpath:/integration/event/shouldNotSendPleaseReviewEmailIfOrderEventIsNotDeliveredStatus.sql" })
  public void shouldNotSendPleaseReviewEmailIfOrderEventIsNotDeliveredStatus() throws Exception {
  ...
  @Test
  @Sql(scripts = { "classpath:/integration/event/shouldSendPleaseReviewEmail.sql" })
  public void shouldSendPleaseReviewEmail() throws Exception {
