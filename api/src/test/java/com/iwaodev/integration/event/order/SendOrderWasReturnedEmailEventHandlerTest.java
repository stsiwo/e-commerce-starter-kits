...
public class SendOrderWasReturnedEmailEventHandlerTest {

  private static final Logger logger = LoggerFactory.getLogger(SendOrderWasReturnedEmailEventHandlerTest.class);
  ...
  @Autowired
  private SendOrderWasReturnedEmailEventHandler handler;
  ...
  @Test
  @Sql(scripts = { "classpath:/integration/event/shouldNotSendOrderWasReturnedEmailIfOrderStatusIsNotReturned.sql" })
  public void shouldNotSendOrderWasReturnedEmailIfOrderStatusIsNotReturned() throws Exception {
  ...
  @Test
  @Sql(scripts = { "classpath:/integration/event/shouldSendOrderWasReturnedEmail.sql" })
  public void shouldSendOrderWasReturnedEmail() throws Exception {
