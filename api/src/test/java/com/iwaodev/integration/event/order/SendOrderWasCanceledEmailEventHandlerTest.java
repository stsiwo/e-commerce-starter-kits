...
public class SendOrderWasCanceledEmailEventHandlerTest {

  private static final Logger logger = LoggerFactory.getLogger(SendOrderWasCanceledEmailEventHandlerTest.class);
  ...
  @Autowired
  private SendOrderWasCanceledEmailEventHandler handler;
  ...
  @Test
  @Sql(scripts = { "classpath:/integration/event/shouldNotSendOrderWasCanceledEmailIfOrderStatusIsNotCanceled.sql" })
  public void shouldNotSendOrderWasCanceledEmailIfOrderStatusIsNotCanceled() throws Exception {
  ...
  @Test
  @Sql(scripts = { "classpath:/integration/event/shouldSendOrderWasCanceledEmail.sql" })
  public void shouldSendOrderWasCanceledEmail() throws Exception {
