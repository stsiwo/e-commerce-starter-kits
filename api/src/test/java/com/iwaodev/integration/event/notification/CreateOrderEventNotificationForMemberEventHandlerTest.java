...
public class CreateOrderEventNotificationForMemberEventHandlerTest {
    ...
    @Autowired
    private CreateOrderEventNotificationForMemberEventHandler handler;
    ...
    @Test
    @Sql(scripts = { "classpath:/integration/event/shouldCreateOrderEventWasUpdatedNotificationForMember.sql" })
    public void shouldCreateOrderEventWasUpdatedNotificationForMember() throws Exception {
        ...
        NotificationType notificationTypeEntity = Optional.ofNullable(notificationTypeList.get(NotificationTypeEnum.ORDER_STATUS_WAS_UPDATED_BY_MEMBER))
        ...
        assertThat(notification.getNotificationTitle()).isEqualTo(notificationTypeEntity.getNotificationTitleTemplate());
        assertThat(notification.getIssuer().getUserId()).isEqualTo(dummyOrder.getUser().getUserId());
        assertThat(notification.getRecipient().getUserId()).isEqualTo(admin.getUserId());
        assertThat(notification.getLink()).isEqualTo(String.format("/admin/orders?orderId=%s", dummyOrder.getOrderId().toString()));
    }
