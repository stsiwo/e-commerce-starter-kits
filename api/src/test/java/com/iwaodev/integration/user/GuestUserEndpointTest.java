...
public class GuestUserEndpointTest {

  private static final Logger logger = LoggerFactory.getLogger(GuestUserEndpointTest.class);
  ...
  @Test
  public void shouldNotGuestUserAccessToThisEndpoint() throws Exception {
