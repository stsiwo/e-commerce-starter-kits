...
import {
  WishlistItemCriteria,
  WishlistItemSortEnum,
  WishlistItemType,
...
export const fetchWishlistItemActionCreator = createAction(
  "saga/domain/wishlistItem/fetch"
);
export const fetchWishlistItemActionTypeName =
  fetchWishlistItemActionCreator().type;

// for POST (add a new wishlist item) request
export declare type PostWishlistItemActionType = WishlistItemCriteria & {
  product: ProductType;
  version: number;
};
export const postWishlistItemActionCreator =
  createAction<PostWishlistItemActionType>("saga/domain/wishlistItem/post");
export const postWishlistItemActionTypeName =
  postWishlistItemActionCreator().type;

// for PATCH (add a new wishlist item) request
export declare type PatchWishlistItemActionType = {
  wishlistItemId: string;
  version: number;
};
export const patchWishlistItemActionCreator =
  createAction<PatchWishlistItemActionType>("saga/domain/wishlistItem/patch");
export const patchWishlistItemActionTypeName =
  patchWishlistItemActionCreator().type;

// for DELETE (delete single wishlist item) request
export declare type DeleteSingleWishlistItemActionType = {
  wishlistItemId: string;
  version: number;
};
export const deleteSingleWishlistItemActionCreator =
  createAction<DeleteSingleWishlistItemActionType>(
    "saga/domain/wishlistItem/deleteSingle"
  );
export const deleteSingleWishlistItemActionTypeName =
  deleteSingleWishlistItemActionCreator().type;

// for DELETE (delete all of wishlist items) request
export const deleteWishlistItemActionCreator = createAction(
  "saga/domain/wishlistItem/delete"
);
export const deleteWishlistItemActionTypeName =
  deleteWishlistItemActionCreator().type;
...
export const wishlistItemSlice = createSlice({
  ...
  reducers: {
    ...
    update: (state: WishlistItemType[], action: WishlistItemActionType) =>
      action.payload,
    ...
    delete: (state: WishlistItemType[], action: PayloadAction<string>) => {
      remove(
        ...
        (wishlistItem: WishlistItemType) =>
          wishlistItem.wishlistItemId == action.payload
      );
      return state;
    },
...
export const wishlistItemQuerySearchQuerySlice = createSlice({
  ...
  reducers: {
    ...
    // use when you want to replace
    update: (state: string, action: WishlistItemQuerySearchQueryActionType) =>
      action.payload,
    clear: (state: string) => "",
  },
  /**
...
export const wishlistItemQuerySearchQuerySliceReducer =
  wishlistItemQuerySearchQuerySlice.reducer;
export const wishlistItemQuerySearchQueryActions =
  wishlistItemQuerySearchQuerySlice.actions;
...
export const wishlistItemQueryCategoryIdSlice = createSlice({
  ...
  reducers: {
    ...
    // use when you want to replace
    update: (state: string, action: WishlistItemQueryCategoryIdActionType) =>
      action.payload,
    clear: (state: string) => "",
  },
  /**
...
export const wishlistItemQueryCategoryIdSliceReducer =
  wishlistItemQueryCategoryIdSlice.reducer;
export const wishlistItemQueryCategoryIdActions =
  wishlistItemQueryCategoryIdSlice.actions;
...
export const wishlistItemQueryMinPriceSlice = createSlice({
  ...
  reducers: {
    ...
    // use when you want to replace
    update: (state: string, action: WishlistItemQueryMinPriceActionType) =>
      action.payload,
...
export const wishlistItemQueryMinPriceSliceReducer =
  wishlistItemQueryMinPriceSlice.reducer;
export const wishlistItemQueryMinPriceActions =
  wishlistItemQueryMinPriceSlice.actions;
...
export const wishlistItemQueryMaxPriceSlice = createSlice({
  ...
  reducers: {
    ...
    // use when you want to replace
    update: (state: string, action: WishlistItemQueryMaxPriceActionType) =>
      action.payload,
    clear: (state: string) => null,
  },
  /**
...
export const wishlistItemQueryMaxPriceSliceReducer =
  wishlistItemQueryMaxPriceSlice.reducer;
export const wishlistItemQueryMaxPriceActions =
  wishlistItemQueryMaxPriceSlice.actions;
...
export const wishlistItemQueryReviewPointSlice = createSlice({
  ...
  reducers: {
    ...
    // use when you want to replace
    update: (state: string, action: WishlistItemQueryReviewPointActionType) =>
      action.payload,
    clear: (state: string) => null,
  },
  /**
...
export const wishlistItemQueryReviewPointSliceReducer =
  wishlistItemQueryReviewPointSlice.reducer;
export const wishlistItemQueryReviewPointActions =
  wishlistItemQueryReviewPointSlice.actions;
...
export const wishlistItemQueryIsDiscountSlice = createSlice({
  ...
  reducers: {
    ...
    // use when you want to replace
    update: (state: boolean, action: WishlistItemQueryIsDiscountActionType) =>
      action.payload,
...
export const wishlistItemQueryIsDiscountSliceReducer =
  wishlistItemQueryIsDiscountSlice.reducer;
export const wishlistItemQueryIsDiscountActions =
  wishlistItemQueryIsDiscountSlice.actions;
...
export const wishlistItemQueryStartDateSlice = createSlice({
  ...
  reducers: {
    ...
    // use when you want to replace
    update: (state: Date, action: WishlistItemQueryStartDateActionType) =>
      action.payload,
...
export const wishlistItemQueryStartDateSliceReducer =
  wishlistItemQueryStartDateSlice.reducer;
export const wishlistItemQueryStartDateActions =
  wishlistItemQueryStartDateSlice.actions;
...
export const wishlistItemQueryEndDateSlice = createSlice({
  ...
  reducers: {
    ...
    // use when you want to replace
    update: (state: Date, action: WishlistItemQueryEndDateActionType) =>
      action.payload,
    clear: (state: Date) => null,
  },
  /**
...
export const wishlistItemQueryEndDateSliceReducer =
  wishlistItemQueryEndDateSlice.reducer;
export const wishlistItemQueryEndDateActions =
  wishlistItemQueryEndDateSlice.actions;
 ...
 **/
// action type
export type WishlistItemQuerySortActionType =
  PayloadAction<WishlistItemSortEnum>;
...
export const wishlistItemQuerySortSlice = createSlice({
  ...
  reducers: {
    ...
    // use when you want to replace
    update: (
      state: WishlistItemSortEnum,
      action: WishlistItemQuerySortActionType
    ) => action.payload,
...
export const wishlistItemQuerySortSliceReducer =
  wishlistItemQuerySortSlice.reducer;
...
export const wishlistItemPaginationPageSlice = createSlice({
  ...
  reducers: {
    ...
    // use when you want to replace
    update: (state: number, action: WishlistItemPaginationPageActionType) =>
      action.payload,
...
export const wishlistItemPaginationPageSliceReducer =
  wishlistItemPaginationPageSlice.reducer;
export const wishlistItemPaginationPageActions =
  wishlistItemPaginationPageSlice.actions;
...
export const wishlistItemPaginationLimitSlice = createSlice({
  ...
  reducers: {
    ...
    // use when you want to replace
    update: (state: number, action: WishlistItemPaginationLimitActionType) =>
      action.payload,
...
export const wishlistItemPaginationLimitSliceReducer =
  wishlistItemPaginationLimitSlice.reducer;
export const wishlistItemPaginationLimitActions =
  wishlistItemPaginationLimitSlice.actions;
...
export const wishlistItemPaginationTotalPagesSlice = createSlice({
  ...
  reducers: {
    ...
    update: (
      state: number,
      action: WishlistItemPaginationTotalPagesActionType
    ) => action.payload,
...
export const wishlistItemPaginationTotalPagesSliceReducer =
  wishlistItemPaginationTotalPagesSlice.reducer;
export const wishlistItemPaginationTotalPagesActions =
  wishlistItemPaginationTotalPagesSlice.actions;
 ...
 **/
// action type
export type WishlistItemPaginationTotalElementsActionType =
...
export const wishlistItemPaginationTotalElementsSlice = createSlice({
  ...
  reducers: {
    ...
    update: (
      state: number,
      action: WishlistItemPaginationTotalElementsActionType
    ) => action.payload,
    clear: (state: number) => 1,
  },
  /**
...
export const wishlistItemPaginationTotalElementsSliceReducer =
  wishlistItemPaginationTotalElementsSlice.reducer;
export const wishlistItemPaginationTotalElementsActions =
  wishlistItemPaginationTotalElementsSlice.actions;
