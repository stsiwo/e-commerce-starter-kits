 ...
 *
 **/
export function* fetchSingleOrderWorker(
  ...
  if (curAuth.userType === UserTypeEnum.ADMIN) {
     ...
     **/
    yield put(getOrderFetchStatusActions.update(FetchStatusEnum.FETCHING));
     ...
     **/
    yield put(getOrderFetchStatusActions.update(response.fetchStatus));
