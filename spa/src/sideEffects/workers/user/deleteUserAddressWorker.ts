 ...
 *
 **/
export function* deleteUserAddressWorker(
  action: PayloadAction<DeleteUserAddressActionType>
) {
  /**
   * get cur user type
   **/
  ...
  if (curAuth.userType === UserTypeEnum.ADMIN) {
     ...
     **/
    yield put(deleteUserAddressFetchStatusActions.update(response.fetchStatus));
