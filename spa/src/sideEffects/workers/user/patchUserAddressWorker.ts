 ...
 *
 **/
export function* patchUserAddressWorker(
  action: PayloadAction<PatchUserAddressActionType>
) {
  /**
   * get cur user type
   **/
  ...
  if (curAuth.userType === UserTypeEnum.ADMIN) {
     ...
     **/
    yield put(patchUserAddressFetchStatusActions.update(response.fetchStatus));
