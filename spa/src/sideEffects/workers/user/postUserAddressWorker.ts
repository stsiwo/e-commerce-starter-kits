 ...
 *
 **/
export function* postUserAddressWorker(
  action: PayloadAction<PostUserAddressActionType>
) {
  /**
   * get cur user type
   **/
  ...
  if (curAuth.userType === UserTypeEnum.ADMIN) {
     ...
     **/
    yield put(postUserAddressFetchStatusActions.update(response.fetchStatus));
