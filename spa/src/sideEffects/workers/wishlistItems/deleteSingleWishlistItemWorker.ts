...
import {
  DeleteSingleWishlistItemActionType,
  wishlistItemActions,
 ...
 *
 **/
export function* deleteSingleWishlistItemWorker(
  action: PayloadAction<DeleteSingleWishlistItemActionType>
) {
  /**
   * get cur user type
   **/
  ...
  if (curAuth.userType === UserTypeEnum.MEMBER) {
     ...
     **/
    yield put(
      deleteSingleWishlistItemFetchStatusActions.update(
