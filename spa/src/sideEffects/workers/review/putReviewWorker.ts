...
export function* putReviewWorker(action: PayloadAction<PutReviewActionType>) {
  ...
  if (
     ...
     **/
    yield put(putReviewFetchStatusActions.update(FetchStatusEnum.FETCHING));
     ...
     **/
    yield put(putReviewFetchStatusActions.update(response.fetchStatus));
    ...
    if (response.fetchStatus === FetchStatusEnum.SUCCESS) {
       ...
       *
       **/
      yield put(reviewActions.updateOne(response.data));
