 ...
 *
 **/
export function* putAuthAddressWorker(
  action: PayloadAction<PutAuthAddressActionType>
) {
  /**
   * get cur user type
   **/
  ...
  if (
     ...
     **/
    yield put(putAuthAddressFetchStatusActions.update(response.fetchStatus));
    ...
    if (response.fetchStatus === FetchStatusEnum.SUCCESS) {
       ...
       *
       **/
      yield put(authActions.updateAddress(response.data));
    ...
    yield put(authActions.updateAddress(action.payload));
  }
}
