 ...
 *
 **/
export function* patchAuthAddressWorker(
  action: PayloadAction<PatchAuthAddressActionType>
) {
  /**
   * get cur user type
   **/
  ...
  if (
     ...
     **/
    yield put(patchAuthAddressFetchStatusActions.update(response.fetchStatus));
    ...
    if (response.fetchStatus === FetchStatusEnum.SUCCESS) {
       ...
       *
       **/
      yield put(authActions.replaceAddress(response.data));
