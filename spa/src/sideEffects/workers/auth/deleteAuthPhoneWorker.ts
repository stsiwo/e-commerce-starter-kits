 ...
 *
 **/
export function* deleteAuthPhoneWorker(
  action: PayloadAction<DeleteAuthPhoneActionType>
) {
  /**
   * get cur user type
   **/
  ...
  if (
     ...
     **/
    yield put(deleteAuthPhoneFetchStatusActions.update(response.fetchStatus));
    ...
    if (response.fetchStatus === FetchStatusEnum.SUCCESS) {
       ...
       *
       **/
      yield put(authActions.deletePhone({ phoneId: action.payload.phoneId }));
