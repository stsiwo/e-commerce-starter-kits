 ...
 *
 **/
export function* postAuthPhoneWorker(
  action: PayloadAction<PostAuthPhoneActionType>
) {
  /**
   * get cur user type
   **/
  ...
  if (
     ...
     **/
    yield put(postAuthPhoneFetchStatusActions.update(FetchStatusEnum.FETCHING));
     ...
     **/
    yield put(postAuthPhoneFetchStatusActions.update(response.fetchStatus));
    ...
    if (response.fetchStatus === FetchStatusEnum.SUCCESS) {
      ...
      log(response.data);
      yield put(authActions.appendPhone(response.data));
