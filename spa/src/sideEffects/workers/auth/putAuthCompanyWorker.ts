 ...
 *
 **/
export function* putAuthCompanyWorker(
  action: PayloadAction<PutAuthCompanyActionType>
) {
  /**
   * get cur user type
   **/
  ...
  if (
     ...
     **/
    yield put(putAuthCompanyFetchStatusActions.update(response.fetchStatus));
