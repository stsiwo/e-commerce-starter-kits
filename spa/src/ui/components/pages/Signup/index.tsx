...
const Signup: React.FunctionComponent<{}> = (props) => {
  ...
  const [curMemberSignupState, setMemberSignupState] =
    React.useState<MemberSignupDataType>(defaultMemberSignupData);

  // validation logic (should move to hooks)
  const [curMemberSignupValidationState, setMemberSignupValidationState] =
    React.useState<MemberSignupValidationDataType>(
