...
import { CategoryType, ProductDataType, defaultProductData, ProductValidationDataType, defaultProductValidationData, ProductVariantSizeType } from 'domain/product/types';
...
import ColorPickerInput from 'components/common/ColorPickInput';
