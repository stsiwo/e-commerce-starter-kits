...
const AdminCustomerStatusForm: React.FunctionComponent<AdminCustomerStatusFormPropsType> =
  (props) => {
    // mui: makeStyles
    ...
    const [curAdminCustomerState, setAdminCustomerState] =
      React.useState<UserStatusAccountDataType>(defaultUserStatusAccountData);
    ...
    const [curAdminCustomerValidationState, setAdminCustomerValidationState] =
      React.useState<UserStatusAccountValidationDataType>(
        defaultUserStatusAccountValidationData
      );
    ...
    // event handlers
    const handleActiveInputChangeEvent: React.EventHandler<
    ...
    const handleActiveNoteInputChangeEvent: React.EventHandler<
      React.ChangeEvent<HTMLInputElement>
    > = (e) => {
