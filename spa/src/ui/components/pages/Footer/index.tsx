  ...
  return (
    <footer className={classes.footer}>
      <Grid container className={classes.gridBox}>
        <Grid item className={classes.columnOne} xs={12} md={4}>
          ...
          <Box className={classes.linkBox}>
            <Link
              href={curCompany ? curCompany.facebookLink : ""}
              target="_blank"
            >
              <FacebookIcon fontSize="large" />
            </Link>
            <Link
              href={curCompany ? curCompany.instagramLink : ""}
              target="_blank"
            >
              <InstagramIcon fontSize="large" />
            </Link>
            <Link
              href={curCompany ? curCompany.twitterLink : ""}
              target="_blank"
            >
              <TwitterIcon fontSize="large" />
            </Link>
            <Link
              href={curCompany ? curCompany.youtubeLink : ""}
              target="_blank"
            >
        ...
        <Grid item className={classes.columnTwo} xs={12} md={4}>
          <Typography variant="h6" component="h6" className={classes.title}>
            {"Links"}
          </Typography>
          <List>
        ...
        <Grid item className={classes.columnThree} xs={12} md={4}>
          <Typography variant="h6" component="h6" className={classes.title}>
            {"Product Search"}
          </Typography>
          <Typography variant="body2" component="p" className={classes.parag}>
