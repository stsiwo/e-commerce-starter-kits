...
const Review: React.FunctionComponent<{}> = (props) => {
  ...
  const [curStatus, setStatus] = React.useState<ReviewFetchResponseEnum>(ReviewFetchResponseEnum.PROCESSING)
    ...
    if (!curReview) {
      ...
      api.request({
        ...
        if (data.data.isExist) {
          ...
          setReview(merge({}, defaultReviewData, { user: data.data.user, product: data.data.product }))
        }
