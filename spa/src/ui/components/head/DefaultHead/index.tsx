  ...
  return (
    <Helmet>
      <meta
        ...
        content={`default-src 'self'; script-src 'self' https://js.stripe.com https://www.google.com/recaptcha/ https://www.gstatic.com/recaptcha/ www.google-analytics.com www.googletagmanager.com 'nonce-${curNonce}'; style-src 'self' 'unsafe-inline' ; img-src 'self' blob: data: ${API1_URL} www.google-analytics.com www.googletagmanager.com; frame-src https://js.stripe.com https://hooks.stripe.com https://www.google.com/recaptcha/ https://recaptcha.google.com/recaptcha/; connect-src 'self' https://api.stripe.com ${API1_URL} www.google-analytics.com`}
      />
