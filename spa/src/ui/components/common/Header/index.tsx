    ...
    <AppBar position="sticky" className={classes.appBar}>
      <Toolbar>
        <Grid justify="space-between" alignItems="center" container>
          ...
          {auth.userType === UserTypeEnum.GUEST && <GuestHeaderMenuItems />}
          {auth.userType === UserTypeEnum.MEMBER && <MemberHeaderMenuItems />}
          {auth.userType === UserTypeEnum.ADMIN && <AdminHeaderMenuItems />}
        </Grid>
      </Toolbar>
    </AppBar>
  );
