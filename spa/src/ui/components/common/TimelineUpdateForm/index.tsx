...
const TimelineUpdateForm: React.FunctionComponent<TimelineUpdateFormPropsType> = ({ orderId, orderEvents }) => {
  ...
  const handleExapandClickEvent: React.EventHandler<React.MouseEvent<HTMLButtonElement>> = (e) => {
  ...
  // save event handler
  const handleNextOrderStatusSaveClickEvent: React.EventHandler<React.MouseEvent<HTMLInputElement>> = (e) => {
    /**
     * #TODO:
