...
const baseMorphDataList: BaseMorphDataType[] = [
  ...
  },
  {
    ...
    pathAlt: "M72.4999 159C117.337 38.5002 245 39.9286 259.5 38.5003C427 22.0004 637.98 20.6121 741 69.0004C840 115.501 902.833 226.334 922.5 287.5C947.5 357.834 945.4 506 909 574C863.5 659 817 726.5 680 735.5C543 744.5 336 762 245 735.5C154 709 111 665.285 72.5 590.285C36.0056 519.192 32.5 266.5 72.4999 159Z",
  }
]
