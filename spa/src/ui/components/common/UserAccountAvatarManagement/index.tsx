 ...
 **/
const UserAccountAvatarManagement: React.FunctionComponent<UserAccountAvatarManagementPropsType> =
  (props) => {
    // mui: makeStyles
    ...
    // avatar image
    const curAvatarImageUrl = useSelector(
      mSelector.makeAuthAvatarUrlSelector()
    );
    ...
    const [curFilePath, setFilePath] =
      React.useState<string>(curAvatarImageUrl);
