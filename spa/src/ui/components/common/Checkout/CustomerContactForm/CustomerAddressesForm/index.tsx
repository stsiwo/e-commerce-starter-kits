 ...
 **/
const CustomerAddressesForm: React.FunctionComponent<CustomerAddressesFormPropsType> =
  (props) => {
    // mui: makeStyles
    ...
    const [curCustomerAddressesFormState, setCustomerAddressesFormState] =
    ...
    const [
      curCustomerAddressesFormValidationState,
    ...
    > = async (e) => {
      ...
      if (isValid) {
        ...
        if (isNew) {
          ...
          dispatch(postAuthAddressActionCreator(curCustomerAddressesFormState));

          setModalOpen(false);
        } else {
          log("this one is to update existing one");

          dispatch(putAuthAddressActionCreator(curCustomerAddressesFormState));
